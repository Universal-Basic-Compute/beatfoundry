...
export async function POST(request, { params }) {
  ...
  try {
    ...
    const trackInstructions = fromThinking
      ? (instrumental
          ? "You are receiving thoughts from an AI musician's autonomous thinking process. YOU MUST RESPOND WITH VALID JSON ONLY. Create a JSON object containing: 1) 'prompt': a detailed description of the musical concept (up to 1000 characters), 2) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters) based on these thoughts, 3) 'title': a creative title for the track inspired by the thoughts, and 4) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences). DO NOT include any explanatory text outside the JSON. This will be an instrumental track without lyrics."
          : "You are receiving thoughts from an AI musician's autonomous thinking process. YOU MUST RESPOND WITH VALID JSON ONLY. Create a JSON object containing: 1) 'prompt': COMPLETE LYRICS for the track (up to 5000 characters) - this will be sung exactly as written, 2) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters), 3) 'title': a creative title for the track inspired by the thoughts, and 4) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences). DO NOT include any explanatory text outside the JSON.")
      : (instrumental
          ? "YOU MUST RESPOND WITH VALID JSON ONLY. No explanatory text. Create a JSON object containing: 1) 'prompt': a detailed description of the musical concept (up to 1000 characters), 2) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters), 3) 'title': a creative title for the track, and 4) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences). This will be an instrumental track without lyrics."
          : "YOU MUST RESPOND WITH VALID JSON ONLY. No explanatory text. Create a JSON object containing: 1) 'prompt': COMPLETE LYRICS for the track (up to 5000 characters) - this will be sung exactly as written, 2) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters), 3) 'title': a creative title for the track, and 4) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences).");
    ...
    try {
      ...
      musicResponse = await generateMusic(
        instrumental ? "" : (musicParams.prompt || musicParams.lyrics || ""), // For non-instrumental: lyrics in prompt field
        musicParams.style, // Style description in style field
        musicParams.title,
