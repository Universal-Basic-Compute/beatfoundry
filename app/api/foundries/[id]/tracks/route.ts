...
export async function POST(request, { params }) {
  ...
  try {
    ...
    const trackInstructions = fromThinking
      ? (instrumental
          ? "You are receiving thoughts from an AI musician's autonomous thinking process. YOU MUST RESPOND WITH VALID JSON ONLY. Create a JSON object containing: 1) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters) based on these thoughts, 2) 'title': a creative title for the track inspired by the thoughts, and 3) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences). DO NOT include any explanatory text outside the JSON. This will be an instrumental track without lyrics."
      ...
      : (instrumental
          ? "YOU MUST RESPOND WITH VALID JSON ONLY. No explanatory text. Create a JSON object containing: 1) 'style': a detailed description of the musical style, sonorities, emotions, and specific instrumentation (up to 1000 characters), 2) 'title': a creative title for the track, and 3) 'presentation': a brief artistic explanation of the concept behind this track (2-3 sentences). This will be an instrumental track without lyrics."
